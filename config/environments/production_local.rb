Rails.application.configure do
  ...
  # Timber.io logger
  send_logs_to_timber = ENV["SEND_LOGS_TO_TIMBER"] || "false" # <---- local production should not send timber logs by default
  ...
  # config.cache_store = :dalli_store, 'localhost:3000'
